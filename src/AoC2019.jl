...
function run_program_async(_data::Array{Int64, 1}, channel_in::Channel{<:Integer}, channel_out::Channel{<:Integer}; memory_size::Int64 = 5000, condition::Condition = nothing)
